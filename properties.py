...
class CC3HairParameters(bpy.types.PropertyGroup):
    ...
    hair_transmission_strength: bpy.props.FloatProperty(default=0.2, min=0, max=1.0, update=lambda s,c: update_property(s,c,"hair_transmission_strength"))
    ...
    hair_soften: bpy.props.FloatProperty(default=0.5, min=0.0, max=1.0, update=lambda s,c: update_property(s,c,"hair_soften"))
